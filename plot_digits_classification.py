    ...
    for test_size in test_sizes:
        for dev_size in dev_sizes:
            ...
            for model_type in classifier_param_dict:
                ...
                lr_models = ["m22aie228_lr_solver_lbfgs.joblib", "m22aie228_lr_solver_liblinear.joblib", "m22aie228_lr_solver_newton-cg.joblib", "m22aie228_lr_solver_sag.joblib", "m22aie228_lr_solver_saga.joblib"]
                if model_type == 'lr':
                    for lr_model in lr_models:    
                        print(lr_model)
                        # loading of model         
                        best_model = load("./models/"+lr_model) 
                        ...
                        cur_run_results = {'model_type': "Logistic Regression", 'run_index': cur_run_i, 'train_acc' : train_acc, 'dev_acc': dev_acc, 'test_acc': test_acc}
                        ...
                        print(f"Logistic Regression Solver = {best_hparams['solver']} - Mean CV Score: {scores.mean():.2f}, Std score = {scores.std():.2f}")
